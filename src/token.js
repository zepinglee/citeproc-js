...
/**
 * Style token.
 * <p>This function generates the tokens in the list that defines
 * the style.  Note that tokens are initially generated by
 * {@link CSL.Core.Build}, but must be post-processed with
 * {@link CSL.Core.Configure} before they can be used to generate
 * citations.</p>
...
CSL.Factory.Token = function(name,tokentype){
	 ...
	 * map to formatting functions in the {@link CSL.Core.Render} phase,
	 ...
	 * function is invoked by the execution wrapper found in
	 * {@link CSL.Core.Render}.</p>
	 */
