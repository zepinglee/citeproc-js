...
CSL.parseParticles = function(){
    ...
    var PARTICLES = [
        ...
        ["at-", either_1],
        ["ath-", either_1],
        ["auf dem", always_non_dropping_2],
        ["auf den", either_2],
        ["auf der", either_2],
        ["auf ter", always_non_dropping_2],
        ["auf", always_non_dropping_1],
        ["aus 'm", always_non_dropping_2],
        ["aus dem", always_non_dropping_2],
        ["aus den", always_non_dropping_2],
        ["aus der", either_2],
        ["aus m", always_non_dropping_2],
        ["aus", always_non_dropping_1],
        ...
        ["vor der", always_non_dropping_2],
        ["vor", always_non_dropping_1],
        ["z", always_dropping_1],
        ["ze", always_dropping_1],
        ["zu", always_non_dropping_1],
        ["zum", either_1],
        ["zur", either_1]
    ]
